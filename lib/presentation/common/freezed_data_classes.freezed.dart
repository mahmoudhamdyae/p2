...
class _$RegisterObjectImpl implements _RegisterObject {
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, countryMobileCode: $countryMobileCode, mobileNumber: $mobileNumber, password: $password, passwordConfirm: $passwordConfirm)';
  }
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(
      ...
      final String mobileNumber,
      final String password,
      final String passwordConfirm) = _$RegisterObjectImpl;
